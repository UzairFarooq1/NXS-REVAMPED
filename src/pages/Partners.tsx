          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {partners.map((partner, i) => (
              ...
              >
                ...
                <p className="text-sm font-heading font-semibold text-primary mb-3">
                  {partner.specialty}
                </p>
