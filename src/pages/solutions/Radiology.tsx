...
const categories: Category[] = [
  {
    ...
    label: "General X-ray",
    intro:
      "Shimadzu offers a comprehensive range of Digital and Analogue General X-ray systems designed for superior imaging quality, efficiency, and patient care. Whether you require advanced digital radiography (DR) solutions for enhanced workflow and image clarity or analogue systems for reliable and cost-effective imaging, Shimadzu delivers innovative solutions tailored to your needs.",
    moreLink: "https://www.shimadzu.com/med/products/radio",
    products: [
      {
        name: "RADspeed fit",
        description:
          "This radiography system integrates ease-of-use features from top-class systems in a simple manner. The system is equipped with a floating tabletop that can support up to 320 kg, and a detachable grid to reduce patient exposure. Furthermore, with its high image quality due to the large output power and simple operability, this radiography system provides a sense of ease and comfort operation for users.",
        image: radspeedFit,
        link: "https://www.shimadzu.com/med/products/radio",
      },
      {
        name: "RADspeed Pro style edition SR5",
        description:
          "The Shimadzu RADspeed Pro SR5 is a high-performance general radiography system designed for versatile and efficient X-ray imaging. It offers advanced automation, superior image quality, and flexible configurations to meet the needs of hospitals, imaging centers, and clinics.",
        image: radspeedProSr5,
        link: "https://www.shimadzu-usa.com/products/radio",
      },
      {
        name: "RADspeed Pro style edition MC",
        description:
          "The RADspeed MF general radiographic system is equipped with an advanced-level generator designed using state-of-the-art high-frequency inverter technology, which produces sharp and high-contrast X-ray images. User-friendly Sequential Multidirectional Radiography functions allow the operator to register and then utilize up to 7 sequential preset memory parameters.",
        image: radspeedMc,
        link: "https://www.shimadzu-usa.com/products/radio",
      },
    ],
  },
  {
    ...
    label: "Mobile X-ray",
    intro:
      "Shimadzu's Mobile X-ray Systems offer the perfect balance of mobility, performance, and reliability for bedside imaging in hospitals, ICUs, emergency rooms, and remote locations. Available in both digital (DR) and analogue (CR/film) configurations, these systems ensure high-quality imaging with ease of use in various clinical settings.",
    moreLink: "https://www.shimadzu.com/med/products/mobile",
    products: [
      {
        name: "MobileDaRt Evolution MX8 Version",
        description:
          "The Shimadzu MobileDaRt Evolution MX8 Version is an advanced digital mobile X-ray system designed for seamless bedside imaging. It features wireless DR technology, a compact and lightweight design, and enhanced maneuverability for use in ICUs, ERs, and operating rooms.",
        image: mobiledartMx8,
        link: "https://www.shimadzu.com/med/products/mobile",
      },
      {
        name: "MOBILEART eco (MUX-10)",
        description:
          "The Shimadzu MOBILEART eco (MUX-10) is a compact and energy-efficient analogue mobile X-ray system, ideal for bedside imaging in hospitals, clinics, and emergency settings. Designed for ease of maneuverability, it features a lightweight body, a long-reach arm, and quiet operation, making it perfect for use in confined spaces.",
        image: mobileartEco,
        link: "https://www.shimadzu.com/med/products/mobile",
      },
    ],
  },
  {
    ...
    label: "C-Arm",
    intro:
      "Shimadzu's Digital & Analogue C-Arm systems offer versatile, high-quality X-ray imaging for surgical, orthopedic, and trauma procedures. Designed for precision, mobility, and ease of use, these systems provide exceptional image clarity and efficient workflow, making them essential for modern healthcare facilities.",
    moreLink: "https://www.shimadzu.com/med/products/c-arm",
    products: [
      {
        ...
        link: "https://www.shimadzu.com/med/products/c-arm",
      },
      {
  ...
  },
  {
    ...
    label: "Fluoroscopy",
    intro:
      "Fluoroscopy is essential for real-time imaging in various medical procedures, and Shimadzu delivers solutions that prioritize clarity, efficiency, and patient safety. Whether choosing a digital system for instant, high-resolution imaging or an analogue system for cost-effective reliability, Shimadzu offers cutting-edge technology tailored to modern healthcare needs.",
    moreLink: "https://www.shimadzu.com/med/products/fluoro",
    products: [
      {
        name: "FLEXAVISION F4 package",
        description:
          "FLEXAVISION F4 package is the latest model of our evolving FLEXAVISION-series equipped with a 17″×17″ FPD which is capable of fluoroscopy and wireless radiography. The high-performance system provides further evolution of its flexibility in fluoroscopic examination, with extensive possibilities in general radiography using a large field of view, wireless FPD.",
        image: flexavisionF4,
        link: "https://www.shimadzu.com/med/products/fluoro",
      },
      {
        name: "FLEXAVISION SF/HB/FD package",
        description:
          "Offering various kinds of table, high-voltage generator, X-ray tube, image intensifier and image processing units, FLEXAVISION enables you to create an optimal system that accommodates both your patient throughput requirement and all your examination types.",
        image: flexavisionSf,
        link: "https://www.shimadzu.com/med/products/fluoro",
      },
    ],
  },
  {
    ...
    label: "Angiography",
    intro:
      "Shimadzu's cath lab angiography systems offer advanced imaging solutions for precise diagnosis and treatment of cardiovascular diseases. Utilizing cutting-edge digital subtraction angiography (DSA) and high-resolution fluoroscopy, Shimadzu's systems provide exceptional image clarity while minimizing radiation exposure.",
    moreLink: "https://www.shimadzu.com/med/products/angio",
    products: [
      {
        name: "Trinias B12s/C16s/C12s/F12s with SCORE Opera",
        description:
          "The Shimadzu Trinias series with SCORE Opera is a Crossover Angiography System designed for various clinical fields, including cardiology, neurology, oncology, emergency/trauma, radiology, surgery, and ICU applications.",
        image: triniasB12s,
        link: "https://www.shimadzu.com/med/products/angio",
      },
      {
        name: "Trinias B8s/C8s/F8s with SCORE Opera",
        description:
          "The Shimadzu Trinias B8s/C8s/F8s with SCORE Opera is a state-of-the-art cardiology-focused angiography system designed for interventional cardiology and peripheral studies. It features an 8″x8″ Flat Panel Detector (FPD) for high-resolution imaging and incorporates SCORE Opera technology.",
        image: triniasB8s,
        link: "https://www.shimadzu.com/med/products/angio",
      },
    ],
