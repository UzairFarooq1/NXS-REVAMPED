...
const categories: Category[] = [
  {
    id: "incubators",
    label: "Incubators",
    intro: "GE Healthcare's incubators provide a controlled, protective environment for newborns, ensuring optimal temperature, humidity, and oxygen levels to support neonatal development. Designed for safety, comfort, and ease of use, these incubators feature advanced thermal regulation, intuitive controls, and seamless access for caregivers. With a focus on infection control and workflow efficiency, GE's incubators integrate innovative technology to enhance neonatal care, helping fragile infants thrive while supporting clinicians with reliable and precise monitoring.",
    products: [
      {
        name: "Giraffe OmniBed Carestation",
        description: "From delivery to discharge, the Giraffe OmniBed Carestation is designed to address the changing and complex demands of the NICU by utilizing advanced technology to provide supportive, family-centered care solutions, consistently-controlled thermal environments, warmth during transport, improved patient access and visibility, and reliable clinical performance.",
      ...
      },
      {
        ...
        description: "Small but Mighty – Empowering Babies' NICU Journey. Combining innovative technology with exceptional thermal performance, the Giraffe Incubator Carestation is a state-of-the-art neonatal environment that promotes natural, peaceful healing, while fostering a close bond between families and their babies—allowing them to be present for every step of the journey.",
  ...
  },
  {
    ...
    intro: "Whether in the newborn nursery or NICU, our warmers will help keep your patients warm, comfortable, and healthy. We've designed all of our warmers to work with additional Infant Care products—and with you, your patients, and your workflow in mind.",
    products: [
      {
        name: "Panda Warmers",
        description: "The Panda Warmer helps you focus on caring for your patients. With simple and easy-to-use features such as hands-free alarm silence, full-color display, and an integrated scale, your caregivers can focus on the most critical aspects of their job—caring for newborns and their families.",
        image: pandaWarmer,
        link: "https://www.gehealthcare.com/products/maternal-infant-care/warmers/panda-warmer",
      },
      {
        name: "Giraffe Warmer",
        description: "The Giraffe Warmer provides easy access to newborns with its innovative recessed heater design, allowing caregivers to work efficiently in tight spaces while ensuring optimal warmth. Its advanced pre-warming feature allows the bed to be heated in advance without triggering alarms, ensuring a ready environment for the infant.",
        image: giraffeWarmer,
        link: "https://www.gehealthcare.com/products/maternal-infant-care/warmers",
      },
      {
        name: "Lullaby Warmer",
        description: "The Lullaby Warmer is designed to provide a stress-free newborn arrival with 66% faster warm-up and uniform heat distribution, ensuring optimal positioning and even warmth via the GelHood heater. Its \"Walls of Warmth\" prevent heat loss, creating a stable environment for neonatal care.",
        image: lullabyWarmer,
        link: "https://www.gehealthcare.com/products/maternal-infant-care/warmers",
      },
    ],
  },
  {
    ...
    intro: "When you're caring for your newborn patients, you want reliable phototherapy equipment that puts infant safety first. GE Healthcare's line of phototherapy products helps you deliver exceptional, effective jaundice management and promote a family-care environment.",
    products: [
      {
        name: "BiliSoft 2.0 Phototherapy System",
        description: "The right touch—and blue light—can make all the difference for infants with jaundice. GE Healthcare's BiliSoft 2.0 Phototherapy System meets or exceeds the American Academy of Pediatrics (AAP) guidelines for intensive phototherapy to effectively treat hyperbilirubinemia and support even the tiniest patients with more comfort, better bonding, and higher quality developmental care.",
        image: bilisoft2,
