...
const categories: Category[] = [
  {
    ...
    label: "Sony Printers",
    intro:
      "Sony's medical printers are designed to meet the highest standards of quality and precision for healthcare environments. These printers offer high-resolution imaging and reliable performance for diagnostic purposes, ensuring clear and accurate prints of medical images. With a range of models that support various media and advanced connectivity, Sony printers are ideal for use in radiology, cardiology, and other medical imaging applications.",
...
const SonyPrinters = () => {
  ...
  return (
    <Layout>
      <PageHero
        title="Printers"
        subtitle="Medical-grade printing solutions"
